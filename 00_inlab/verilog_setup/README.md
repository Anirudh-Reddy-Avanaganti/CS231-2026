...
## Verilog
We will be using `icarus-verilog` (iverilog) for simulations and [VerilogHDL/SystemVerilog extension](vscode:extension/mshr-h.veriloghdl) for Syntax-Highlighting and [VapourView](vscode:extension/lramseyer.vaporview) for obseving the waveforms.
